"""
Subject 21 (PD) ECoG — analysis split by the user-defined epochs in
data.trials.t1.epochs (e1..e33), each a [start,end] sample-index pair.

Uses the stored reference PSDs in data.trials.t1.psd.eN.saw (513x6, 0-500 Hz)
...
m = sio.loadmat("/Users/terry/Documents/21data.mat",
...
out_csv="/Users/terry/Documents/sbj21_epoch_split_bandpower.csv"
...
fig.suptitle(f"Subject 21 (PD) · split by {n_ep} defined epochs "
...
axB.set_title("B · Stored PSD per epoch (channel-averaged, colored e1→e33)",
              loc="left",fontweight="bold")
...
fig.savefig("/Users/terry/Documents/sbj21_epoch_split_overview.png",dpi=200,
...
fig2.suptitle(f"Subject 21 (PD) · band power across {n_ep} defined epochs",
            fontsize=12,fontweight="bold",color=NAVY)
fig2.savefig("/Users/terry/Documents/sbj21_epoch_split_heatmap.png",dpi=200,
            facecolor="white",bbox_inches="tight")
print("saved heatmap")
