"""
Subject 26 (PD) ECoG — analysis split by the user-defined epochs in
...
m = sio.loadmat("/Users/terry/Documents/26data.mat",
...
out_csv="/Users/terry/Documents/sbj26_epoch_split_bandpower.csv"
...
fig.suptitle(f"Subject 26 (PD) · split by {n_ep} defined epochs "
...
fig.savefig("/Users/terry/Documents/sbj26_epoch_split_overview.png",dpi=200,
...
fig2.suptitle(f"Subject 26 (PD) · band power across {n_ep} defined epochs",
            fontsize=12,fontweight="bold",color=NAVY)
fig2.savefig("/Users/terry/Documents/sbj26_epoch_split_heatmap.png",dpi=200,
            facecolor="white",bbox_inches="tight")
print("saved heatmap")
